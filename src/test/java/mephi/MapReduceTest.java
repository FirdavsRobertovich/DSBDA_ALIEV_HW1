...
public class MapReduceTest {
    ...
    public void testMapper() throws Exception {
        ...
        mapDriver.withOutput(new Text("life"), new IntWritable(4));
    ...
    public void testReducer() throws Exception {
        ...
        reduceDriver.withInput(new Text("life"), v2);
        reduceDriver.withOutput(new Text("life"), new IntWritable(4));
    ...
    public void testMapReduce() throws Exception {
        ...
        mapReduceDriver.withOutput(new Text("life"), new IntWritable(4));
